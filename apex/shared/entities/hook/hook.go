...
// The ApexCustomerFunc type is an adapter to allow the use of ordinary
// function as ApexCustomer mutator.
type ApexCustomerFunc func(context.Context, *entities.ApexCustomerMutation) (entities.Value, error)

// Mutate calls f(ctx, m).
func (f ApexCustomerFunc) Mutate(ctx context.Context, m entities.Mutation) (entities.Value, error) {
	if mv, ok := m.(*entities.ApexCustomerMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *entities.ApexCustomerMutation", m)
}

// The ApexCustomerIdentityFunc type is an adapter to allow the use of ordinary
// function as ApexCustomerIdentity mutator.
type ApexCustomerIdentityFunc func(context.Context, *entities.ApexCustomerIdentityMutation) (entities.Value, error)

// Mutate calls f(ctx, m).
func (f ApexCustomerIdentityFunc) Mutate(ctx context.Context, m entities.Mutation) (entities.Value, error) {
	if mv, ok := m.(*entities.ApexCustomerIdentityMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *entities.ApexCustomerIdentityMutation", m)
}
