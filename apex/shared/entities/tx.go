...
func (tx *Tx) init() {
	tx.ApexCustomer = NewApexCustomerClient(tx.config)
	tx.ApexCustomerIdentity = NewApexCustomerIdentityClient(tx.config)
}
...
// applies a query, for example: ApexCustomer.QueryXXX(), the query will be executed
